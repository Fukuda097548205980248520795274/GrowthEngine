...
/// @brief コンストラクタ
/// @param func 
Engine::Collision3DRayData::Collision3DRayData(const std::string& name, Collision3D::Type type, Collision3DHandle hCollision)
...
/// @brief デバッグ用の線を描画する
void Engine::Collision3DRayData::DebugDrawLine()
{
