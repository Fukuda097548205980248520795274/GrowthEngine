...
void Engine::SpriteStore::Initialize(ID3D12Device* device, Log* log)
{
	...
	vertexResource_->data_[0].position = Vector4(-1.0f, -1.0f, 0.0f, 1.0f);
	vertexResource_->data_[0].texcoord = Vector2(0.0f, 1.0f);

	vertexResource_->data_[1].position = Vector4(-1.0f, 1.0f, 0.0f, 1.0f);
	...
	vertexResource_->data_[3].position = Vector4(1.0f, 1.0f, 0.0f, 1.0f);
