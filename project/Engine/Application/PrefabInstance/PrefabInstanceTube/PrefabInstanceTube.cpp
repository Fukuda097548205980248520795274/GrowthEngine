#include "PrefabInstanceTube.h"

/// @brief コンストラクタ
/// @param drawCall 
PrefabInstanceTube::PrefabInstanceTube(std::function<void(const Engine::Prefab3D::Tube::Instance::Param*)> drawCall, Engine::Prefab3D::Tube::Base::Param* param)
	: drawCall_(drawCall)
{
	// トランスフォーム
	...
	param_.size.height = param->size.height;
