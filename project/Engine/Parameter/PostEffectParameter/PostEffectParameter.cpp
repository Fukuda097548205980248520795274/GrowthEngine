...
/// @param fileName 
void Engine::PostEffectParameter::RegisterGroupDataReflection(const std::string& fileName)
{
	// ファイルパス
...
/// @brief ファイルを記録する
/// @param fileName 
void Engine::PostEffectParameter::SaveFile(const std::string& fileName)
{
	// グループを検索
