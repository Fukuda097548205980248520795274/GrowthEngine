#include "PostEffectParameter.h"

/// @brief 更新処理
void Engine::PostEffectParameter::Update()
{
...
/// @param groupName 
void Engine::PostEffectParameter::RegisterGroupDataReflection(const std::string& groupName)
{
	// ファイルパス
...
/// @brief ファイルを記録する
/// @param groupName 
void Engine::PostEffectParameter::SaveFile(const std::string& groupName)
{
	// グループを検索
