...
namespace Engine
{
	class PostEffectParameter : public Parameter
	{
	public:
		...
		/// @param directory 
		PostEffectParameter(const std::string& settingTypeName, const std::string& directory) : Parameter(settingTypeName, directory) {}
