#include "Render3DParameter.h"

/// @brief 登録した調整項目の値に、ファイルの値を反映させる
/// @param fileName 
void Engine::Render3DParameter::RegisterGroupDataReflection(const std::string& fileName)
{
	// ファイルパス
...
/// @brief ファイルを記録する
/// @param fileName 
void Engine::Render3DParameter::SaveFile(const std::string& fileName)
{
	// グループを検索
