...
/// @brief 更新処理
void Engine::SpriteParameter::Update()
{
...
/// @param groupName 
void Engine::SpriteParameter::RegisterGroupDataReflection(const std::string& groupName)
{
	// ファイルパス
...
/// @brief ファイルを記録する
/// @param groupName 
void Engine::SpriteParameter::SaveFile(const std::string& groupName)
{
	// グループを検索
