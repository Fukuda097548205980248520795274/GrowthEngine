#include "ComputePSOHighLuminanceExtraction.h"
#include "Log/Log.h"
...
/// @param compiler 
/// @param log 
void Engine::ComputePSOHighLuminanceExtraction::Initialize(ID3D12Device* device, ShaderCompiler* compiler, Log* log)
{
	// シェーダのバイナリデータを取得する
	computeShaderBlob_ = compiler->Compile(L"./Assets/Shader/PostEffect/HighLuminanceExtraction.CS.hlsl", L"cs_6_0");
