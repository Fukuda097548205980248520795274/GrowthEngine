...
/// @param compiler 
/// @param log 
void Engine::ComputePSOTube::Initialize(ID3D12Device* device, ShaderCompiler* compiler, Log* log)
{
	// シェーダのバイナリデータを取得する
	computeShaderBlob_ = compiler->Compile(L"./Assets/Shader/Primitive/Tube.CS.hlsl", L"cs_6_0");
