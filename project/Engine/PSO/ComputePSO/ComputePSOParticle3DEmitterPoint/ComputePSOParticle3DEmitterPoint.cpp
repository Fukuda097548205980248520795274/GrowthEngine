#include "ComputePSOParticle3DEmitterPoint.h"
#include "Log/Log.h"
...
/// @param compiler 
/// @param log 
void Engine::ComputePSOParticle3DEmitterPoint::Initialize(ID3D12Device* device, ShaderCompiler* compiler, Log* log)
{
	// シェーダのバイナリデータを取得する
	computeShaderBlob_ = compiler->Compile(L"./Assets/Shader/Particle3D/Emitter/Particle3DEmitterPoint.CS.hlsl", L"cs_6_0");
