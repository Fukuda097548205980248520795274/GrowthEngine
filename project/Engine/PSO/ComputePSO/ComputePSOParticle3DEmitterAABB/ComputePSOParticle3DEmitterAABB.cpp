#include "ComputePSOParticle3DEmitterAABB.h"
#include "Log/Log.h"
...
/// @param compiler 
/// @param log 
void Engine::ComputePSOParticle3DEmitterAABB::Initialize(ID3D12Device* device, ShaderCompiler* compiler, Log* log)
{
	// シェーダのバイナリデータを取得する
	computeShaderBlob_ = compiler->Compile(L"./Assets/Shader/Particle3D/Emitter/Particle3DEmitterAABB.CS.hlsl", L"cs_6_0");
