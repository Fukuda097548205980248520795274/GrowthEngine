#include "PSOMotionVectorRender.h"
#include <cassert>
...
/// @param compiler 
/// @param log 
void Engine::PSOMotionVectorRender::Initialize(ID3D12Device* device, ShaderCompiler* compiler, IDxcBlob* pixelShaderBlob, Log* log)
{
	// 頂点シェーダを読み込む
	vertexShaderBlob_ = compiler->Compile(L"./Assets/Shader/MotionVector/MotionVectorRender.VS.hlsl", L"vs_6_0");
