...
/// @param compiler 
/// @param log 
void Engine::PSOOutlinePrefab::Initialize(ID3D12Device* device, ShaderCompiler* compiler, Log* log)
{
	// 頂点シェーダを読み込む
	vertexShaderBlob_ = compiler->Compile(L"./Assets/Shader/Outline/OutlinePrefab/OutlinePrefab.VS.hlsl", L"vs_6_0");
	assert(vertexShaderBlob_ != nullptr);

	// ピクセルシェーダを読み込む
	pixelShaderBlob_ = compiler->Compile(L"./Assets/Shader/Outline/OutlinePrefab/OutlinePrefab.PS.hlsl", L"ps_6_0");
