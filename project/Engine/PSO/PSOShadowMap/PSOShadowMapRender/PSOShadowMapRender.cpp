...
/// @param compiler 
/// @param log 
void Engine::PSOShadowMapRender::Initialize(ID3D12Device* device, ShaderCompiler* compiler, Log* log)
{
	// 頂点シェーダを読み込む
	vertexShaderBlob_ = compiler->Compile(L"./Assets/Shader/ShadowMap/ShadowMapRender.VS.hlsl", L"vs_6_0");
