...
/// @param log 
void Engine::PSOPrefab3DTube::Initialize(ID3D12Device* device, IDxcBlob* vertexShaderBlob, IDxcBlob* pixelShaderBlob, Log* log)
{
	// nullptrチェック
	assert(device);
	...
	rootParameter[10].Descriptor.ShaderRegister = 0;
