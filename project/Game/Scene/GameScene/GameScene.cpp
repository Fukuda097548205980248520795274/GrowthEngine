...
void GameScene::Initialize()
{
	...
	collisionA_ = std::make_unique<Collision3DBaseOBB>("CollisionA");
	collisionA0_ = collisionA_->CreateInstance();
	
	collisionB_ = std::make_unique<Collision3DBaseOBB>("CollisionB");
	collisionB0_ = collisionB_->CreateInstance();
	collisionB0_->param_->center = Vector3(0.5f, 0.5f, 0.5f);
