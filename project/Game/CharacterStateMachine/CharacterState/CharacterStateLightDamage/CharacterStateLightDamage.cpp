#include "CharacterStateLightDamage.h"
#include "Entity/Character/Character.h"

/// @brief コンストラクタ
	/// @param owner 
CharacterStateLightDamage::CharacterStateLightDamage(Character* owner, AnimationHandle hFront, AnimationHandle hBack, AnimationHandle hLeft, AnimationHandle hRight)
	: CharacterState(owner), hFront_(hFront), hBack_(hBack), hLeft_(hLeft), hRight_(hRight)
{
}

/// @brief この状態に入るときに呼ばれる処理
void CharacterStateLightDamage::Enter()
{
...
/// @brief 更新処理
/// @param dt 
void CharacterStateLightDamage::Update(float dt)
{
	// ダメージタイマーを更新する
	damageTimer_ -= dt;
...
void CharacterStateLightDamage::Exit()
{
	// ダメージリアクションをリセットする
...
/// @param hitPosition 
/// @param attacker 
void CharacterStateLightDamage::DamageReaction(const std::optional<Vector3>& hitPosition)
{
